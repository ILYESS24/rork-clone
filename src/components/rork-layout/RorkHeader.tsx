...
import { Zap, Code, Sparkles, Menu, X } from 'lucide-react';
import { useState } from 'react';

export function RorkHeader() {
          ...
          <div className="md:hidden py-4 border-t border-gray-200/50">
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200/50">
                <button className="w-full mb-2 px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors">
                  Sign In
                </button>
                <button className="w-full px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200">
                  Get Started
                </button>
              </div>
            </div>
